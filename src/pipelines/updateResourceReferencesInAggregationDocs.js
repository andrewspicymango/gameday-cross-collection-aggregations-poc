...
async function updateResourceReferencesInAggregationDocs(mongo, config, aggregationDoc, resourceReference, requestId) {
	...
	else if (resourceReference.resourceType === 'event') referenceToManage = { events: resourceReference.objectId, eventKeys: resourceReference.externalKey };
	else if (resourceReference.resourceType === 'sgo') referenceToManage = { sgos: resourceReference.objectId, sgoKeys: resourceReference.externalKey };
	else if (resourceReference.resourceType === 'team') referenceToManage = { teams: resourceReference.objectId, teamKeys: resourceReference.externalKey };
	else if (resourceReference.resourceType === 'club') referenceToManage = { clubs: resourceReference.objectId, clubKeys: resourceReference.externalKey };
	else if (resourceReference.resourceType === 'venue') referenceToManage = { venues: resourceReference.objectId, venueKeys: resourceReference.externalKey };
	else if (resourceReference.resourceType === 'keyMoment') referenceToManage = { keyMoments: resourceReference.objectId, keyMomentKeys: resourceReference.externalKey };
	else if (resourceReference.resourceType === 'sportsPerson')
		referenceToManage = { sportsPersons: resourceReference.objectId, sportsPersonKeys: resourceReference.externalKey };
...
////////////////////////////////////////////////////////////////////////////////
module.exports = { updateResourceReferencesInAggregationDocs };
